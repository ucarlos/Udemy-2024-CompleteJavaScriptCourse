/*
 * -----------------------------------------------------------------------------
 * Created by Ulysses Carlos on 11/07/2025 at 03:26 PM
 *
 * Lecture142.challenge.js
...
const poll = {
    ...
    registerNewAnswer() {
        ...
        let promptMessage = `${question}${this.options.join("\n")}`;
        
        while (!validInput) {
            let input = window.prompt(promptMessage).trim;
