/*
 * ------------------------------------------------------------------------------
 * Created by Ulysses Carlos on 01/17/2024 at 10:43 PM
 *
 * Challenge06.js
 ...
 * Create an array called tips containing the tip value for each bill, calculated from
...
// Ternary function for this would be the following:
const calcTip = (bill_amount) => (50 <= bill_amount && bill_amount <= 300)? (.15 * bill_amount) : (.20 * bill_amount);
